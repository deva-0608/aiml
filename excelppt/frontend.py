# frontend.py
# Streamlit UI that matches your screenshot flow.
# - Upload CSV/XLSX
# - Choose Theme (purely cosmetic here; pass along to your pipeline if you want)
# - Live status/polling; when PPT is ready, show a slide-by-slide preview
# - Download PPT
#
# Run: streamlit run frontend.py
# Make sure FastAPI is running at http://localhost:8000  (change BASE_URL below if needed)
